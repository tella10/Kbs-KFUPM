	...
	UM()->admin_forms( array(
		...
		'fields'    => array(
			array(
				...
				'type'      => 'checkbox',
				'label'     => __( 'Disable forums tab?', 'um-forumwp' ),
				'tooltip'   => __( 'If you turn this off, this role will not have a forums tab active in their profile.', 'um-forumwp' ),
				'value'     => ! empty( $role['_um_disable_forumwp_tab'] ) ? $role['_um_disable_forumwp_tab'] : 0,
			),
			array(
				'id'        => '_um_disable_create_forumwp_topics',
				'type'      => 'checkbox',
				'label'     => __( 'Disable create new topics?', 'um-forumwp' ),
				'tooltip'   => __( 'Generally, decide If this role can create new topics in the forums or not.', 'um-forumwp' ),
			...
			array(
				...
				'type'          => 'textarea',
				'label'         => __( 'Custom message to show if you force locking new topic', 'um-forumwp' ),
			...
			array(
				...
				'type'      => 'checkbox',
				'label'     => __( 'Disable create new replies?', 'um-forumwp' ),
				'tooltip'   => __( 'Generally, decide If this role can create new replies in the forums or not.', 'um-forumwp' ),
			...
			array(
				...
				'type'          => 'textarea',
				'label'         => __( 'Custom message to show if you force locking new reply', 'um-forumwp' ),
